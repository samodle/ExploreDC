...
open class SMSegmentView: SMBasicSegmentView {
    ...
    @objc public init(frame: CGRect, separatorColour: UIColor, separatorWidth: CGFloat, segmentProperties: Dictionary<String, AnyObject>?) {
    ...
    @objc open func addSegmentWithTitle(_ title: String?){
        ...
        segment.title = title
        segment.onSelectionImage = nil//onSelectionImage
        segment.offSelectionImage = nil//offSelectionImage
