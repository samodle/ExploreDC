...
open class SMSegment: SMBasicSegment {
    ...
    @objc open var verticalMargin: CGFloat = 5.0 {
        didSet {
            self.resetContentFrame()
        }
    }
    ...
    // Segment Colour
    @objc open var onSelectionColour: UIColor = UIColor.darkGray {
        didSet {
    ...
    @objc open var offSelectionColour: UIColor = UIColor.white {
        didSet {
    ...
    @objc open var onSelectionTextColour: UIColor = UIColor.white {
        didSet {
            if self.isSelected == true {
    ...
    @objc open var offSelectionTextColour: UIColor = UIColor.darkGray {
        didSet {
            if self.isSelected == false {
    ...
    @objc open var titleFont: UIFont = UIFont.systemFont(ofSize: 17.0) {
        didSet {
    ...
    // Segment Image
    @objc open var onSelectionImage: UIImage? {
        didSet {
    ...
    @objc open var offSelectionImage: UIImage? {
        didSet {
